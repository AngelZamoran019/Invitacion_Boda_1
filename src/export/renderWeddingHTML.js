...
export function renderWeddingHTML(project) {
  ...
  // El documento exportado debe comportarse como una experiencia a pantalla completa.
  // La VP ya simula el formato móvil; la exportación no debe crear una tarjeta estrecha
  // ni dejar la textura fuera del contenido en pantallas grandes.
  const fullViewportCss = `<style id="wedding-full-viewport">html,body{width:100%!important;height:100%!important;min-width:0!important;min-height:100%!important;margin:0!important;padding:0!important;overflow:hidden!important;background:var(--bg)!important}body{display:block!important;place-items:initial!important}.phone,.phone.invite-open{position:relative;width:100vw!important;max-width:none!important;height:100dvh!important;min-height:100dvh!important;max-height:100dvh!important;margin:0!important;border-radius:0!important;box-shadow:none!important;overflow-x:hidden}.phone::before{left:0!important;right:0!important;top:0!important;bottom:0!important;width:100vw!important;height:100dvh!important}.cover,.section,.closing{width:100%!important;max-width:100%!important}.cover h1,.cover-subtitle,.date,.venue,.text,.section h2{max-width:min(330px,100%)!important}@media(min-width:700px){body{display:block!important;padding:0!important;background:var(--bg)!important}.phone{width:100vw!important;max-width:none!important;border-radius:0!important;box-shadow:none!important}}@supports(height:100svh){.phone,.phone.invite-open{height:100svh!important;min-height:100svh!important;max-height:100svh!important}.phone::before{height:100svh!important}}</style>`
  html = html.replace('</head>', `${fullViewportCss}</head>`)
