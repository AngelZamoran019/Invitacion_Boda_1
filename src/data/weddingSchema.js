export const createDefaultWeddingProject = () => ({
  ...
  appearance: {
    backgroundColor:'#0b1730', backgroundMode:'solid', backgroundGradient:'', backgroundTextureType:'image', backgroundTextureImage:'', backgroundTexture:'none', backgroundTextureOpacity:0.28, backgroundTextureColor:'#ffffff', backgroundTextureBlend:'soft-light', backgroundTextureSize:'cover',
  ...
  couple:{name1:'',name2:'',photo:'',photoOverlayOpacity:0.55,quote:''}, music:{enabled:false,url:'',title:''}, story:{title:'Nuestra historia',text:'',images:[]},
